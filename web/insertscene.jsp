<%-- 
    ...
    Created on : Jul 15, 2020, 1:53:59 PM
    Author     : User
--%>
        ...
        <div class="main">
            ...
            <div class="container">
                <div class="signup-content">
                    <s:form action="InsertSceneAction" method="POST" id="signup-form" class="signup-form">
                        <h2>Insert Scene</h2>
                        <div class="form-group">
                            <s:textfield name="id" label="SceneId" class="form-input"
                                         id="name"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                        <s:submit value="Insert" name="submit" id="submit" class="form-submit submit"/>
                        </div>
                    </s:form>
                </div>
            </div>
